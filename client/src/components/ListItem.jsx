...
function ListItem({value}) {
    ...
    console.log(value)
    return (
    <div class="animate-spawn opacity-0 w-[20rem] h-32 bg-green-600 justify-self-center flex  items-end justify-center rounded-lg hover:cursor-pointer hover:scale-y-125 group transition-all ease-in-out duration-300 hover:border overflow-hidden relative flex-col">
