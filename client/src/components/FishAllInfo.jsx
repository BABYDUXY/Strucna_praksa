...
function FishAllInfo({value}) {
  return (
    <div className=" w-screen min-h-screen grid grid-rows-[repeat(10,10%);] grid-cols-[15%_1fr_15%]">
        <Link to="/" className='hover:cursor-default w-min h-min'><img className='m-10 transition-all duration-200 ease-in-out hover:cursor-pointer -scale-x-100 hover:-translate-y-1 hover:-scale-x-110' src="../img/arrow.png" alt="" /></Link>
        ...
        <div className='col-start-2 row-start-5  rounded-lg py-4 row-span-4 w-[35%] ml-[5%] flex-col flex items-center gap-8 '>
            ...
            <ul className='flex flex-col gap-4 text-lg'>
                <li><b>Ostali nazivi:</b><br></br>{value.ostali_nazivi}</li>
